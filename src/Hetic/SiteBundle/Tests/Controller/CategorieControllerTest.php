...
class CategorieControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $crawler = $client->request('GET', '/g2/categorie/');
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'hetic_sitebundle_categorie[title]'  => 'Mon titre',
            'hetic_sitebundle_categorie[description]'  => 'Blabla...blabla...',
        ...
        $form = $crawler->selectButton('Update')->form(array(
            'hetic_sitebundle_categorie[title]'  => 'Mon titre 2',
            'hetic_sitebundle_categorie[description]'  => 'Autre Blabla...blabla...',
        ));
