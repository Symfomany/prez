...
class PostControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $crawler = $client->request('GET', '/g2/post/');
...
//        $this->assertGreaterThan(0, $crawler->filter('td:contains("post de test")')->count(), 'Missing element td:contains("post de test")');
        ...
        $form = $crawler->selectButton('Update')->form(array(
            'hetic_sitebundle_post[title]'  => 'Titre 2 de mon post de test modifié',
            'hetic_sitebundle_post[description]'  => 'La fameuse et longue description modifiée de mon post de test',
            'hetic_sitebundle_post[visible]'  => 1,
            'hetic_sitebundle_post[tag]'  => array(2)
        ));
